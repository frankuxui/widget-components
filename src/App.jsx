    ...
    <div className='App pt-16 pb-16'>
      ...
      <div className='box-border mx-4 max-w-full sm:columns-2 md:columns-2 lg:columns-4 xl:columns-5 gap-4'>
        ...
        <div className='break-inside flex bg-white rounded-xl p-4 mb-4'>
          <div className='flex items-start space-x-4'>
            <svg width='64' height='64' viewBox='0 0 1024 1024' fill='#232f3e'>
            ...
            <div className='flex-auto'>
              <h5 className='no-underline font-bold text-2xl mb-2'>Amazon</h5>
              <div className='flex items-center'>
              ...
              <div className='mt-2'>
                <a href='#' className='text-blue-500 font-bold inline-flex items-center'>
